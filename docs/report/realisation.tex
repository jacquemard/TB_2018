...
Ainsi, il est possible d'agir rapidemment lors d'une perte de connexion à la caméra. Le log associé étant de type (\textit{ERROR}), un mail est envoyé. Si la caméra est reconnectée (\textit{WARNING}), un mail est aussi reçu.
